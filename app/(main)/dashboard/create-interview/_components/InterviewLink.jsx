...
import { ArrowLeft, Calendar, Clock, Copy, List, Mail, Mailbox, Plus } from 'lucide-react'
  ...
  return (
    <div className="flex flex-col items-center justify-center mt-10">
      ...
      <div className="text-center mt-4">
        ...
        <p className="text-gray-600">Share this link with your friend:</p>
      </div>
      ...
      <div className='mt-6 bg-white p-5 rounded-lg w-full'>
        ...
        <Button variant={'outline'} className=''><Mailbox/>WhatsApp</Button>
